...
namespace theme_sleat\output\core;
...
class course_renderer extends \core_course_renderer {
    ...
    public function course_search_form($value = '', $format = 'plain') {
        ...
        return $this->render_from_template('theme_sleat/course_search_form', $data);
    }
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
        ...
        $content .= html_writer::start_tag('div', array('class' => 'course-item col-xs-12 col-sm-6 col-md-4'));
    ...
    public function course_section_cm_list_item($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = array()) {
        ...
        if($this->page->theme->settings->activity_tiles && $mod->modname != 'label') {
            $courseTilesClass = 'col-xs-12 col-sm-6 col-md-3 htm-tiles';
